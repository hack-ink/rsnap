...
final class ColorRollCoordinator {
	...
	init(
		...
		self.textLayerFactory = RollTextLayerFactory(
	...
	private func removeRollLayerAnimations() {
		...
		for sublayer in hudHexRollLayer.sublayers ?? [] {
			RollTextLayerFactory.removeAnimationsRecursively(from: sublayer)
		}
	}
