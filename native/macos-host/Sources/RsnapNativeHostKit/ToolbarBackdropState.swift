...
package struct GlassPatchCache {
...
package struct ToolbarBackdropCaptureStart: Equatable {
...
package struct ToolbarBackdropChange: Equatable {
...
package struct ToolbarBackdropRefresh: Equatable {
	package let gapMilliseconds: Double?
...
package struct ToolbarBackdropState {
	...
	package private(set) var seedPatchCache: GlassPatchCache?
	...
	package mutating func storeSeedPatch(
		...
		seedPatchCache = GlassPatchCache(
			frame: frame,
	...
	package mutating func beginCapture(
		...
		captureGeneration &+= 1
		return ToolbarBackdropCaptureStart(
