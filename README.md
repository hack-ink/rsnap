...
- The scroll-capture engine, deterministic replay, and benchmark surfaces remain in the repository,
  but the v0.1.4 native-host release does not expose scroll capture in the toolbar.
...
- The retained scroll-capture path uses Screen Recording-backed screenshots plus forwarded wheel
  input, but the v0.1.4 native-host release does not expose scroll capture in the toolbar.
...
Scroll capture is temporarily hidden in the v0.1.4 native-host release. The retained Rust
