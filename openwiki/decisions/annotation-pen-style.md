...
description: "Accepted rationale, alternatives, and consequences for Annotation Pen Style."
type: "Decision"
status: active
authority: normative
owner: acg-box/rsnap
...
- Users prefer a polished handwritten annotation look over faithful reproduction of every mouse
  wobble.
- The governing behavior contract for this decision is [`openwiki/spec/annotation-pen.md`](../spec/annotation-pen.md).
...
This rationale is implemented as requirements by the [Annotation Pen Contract](../spec/annotation-pen.md) and applies within the Frozen editing lifecycle defined by the [Capture Session Contract](../spec/capture-session.md).
