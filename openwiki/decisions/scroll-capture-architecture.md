...
description: "Accepted rationale, alternatives, and consequences for Scroll Capture Architecture."
type: "Decision"
status: active
authority: normative
owner: acg-box/rsnap
...
Supporting research contract: [`openwiki/research/scroll-capture-prior-art-2026-05-10.md`](../research/scroll-capture-prior-art-2026-05-10.md).
...
The [Capture Session Contract](../spec/capture-session.md) owns current scroll-capture requirements, while the [Scroll-Capture Recovery Plan](../runbook/scroll-capture-recovery-plan.md) validates this architecture in live target applications. The dated [prior-art research](../research/scroll-capture-prior-art-2026-05-10.md) preserves its evidence provenance.
