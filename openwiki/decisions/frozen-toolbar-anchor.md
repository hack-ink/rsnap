...
description: "Accepted rationale, alternatives, and consequences for Frozen Toolbar Stable Anchor."
type: "Decision"
status: active
authority: normative
owner: acg-box/rsnap
...
- The governing behavior contract for this decision is [`openwiki/spec/frozen-toolbar-layout.md`](../spec/frozen-toolbar-layout.md).
...
The [Frozen Toolbar Layout Contract](../spec/frozen-toolbar-layout.md) owns the resulting normative geometry. The toolbar is surfaced by the Frozen-mode interaction described in the [Capture Session Contract](../spec/capture-session.md).
