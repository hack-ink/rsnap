...
description: "Accepted rationale, alternatives, and consequences for Native Host / Rust Core Reset."
type: "Decision"
status: active
authority: normative
owner: acg-box/rsnap
...
The [Platform Host Boundary](../spec/platform-host-boundary.md) turns this accepted direction into ownership rules, and the [Host/Core Protocol](../spec/host-core-protocol.md) defines the semantic and ABI surfaces that carry those rules. The current migration posture is described by the [Host/Core Reset Reference](../reference/host-core-reset.md).
