...
- Some scroll-capture pages still describe v0.2.5 as current while the workspace manifest reports version 0.3.2. Preserve those dated claims as history and use current source for release status.
