...
description: "Normative requirements and invariants for Frozen Toolbar Layout Contract."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
the stable-anchor interaction model was chosen. Use `openwiki/reference/` for current implementation
context and [`openwiki/decisions/frozen-toolbar-anchor.md`](../decisions/frozen-toolbar-anchor.md) for rationale.
...
The [Frozen Toolbar Stable Anchor decision](../decisions/frozen-toolbar-anchor.md) records the rationale for this geometry contract. The toolbar is part of the Frozen state governed by the [Capture Session Contract](./capture-session.md).
