...
description: "Normative requirements and invariants for Rsnap Annotation Pen Contract."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
[`openwiki/decisions/annotation-pen-style.md`](../decisions/annotation-pen-style.md) for rationale and `openwiki/reference/` for implementation
context.
...
- [`openwiki/decisions/annotation-pen-style.md`](../decisions/annotation-pen-style.md)

## Related concepts

The [Annotation Pen Style decision](../decisions/annotation-pen-style.md) explains why polished strokes take precedence over raw pointer fidelity. The [Capture Session Contract](./capture-session.md) places pen editing in the wider Frozen-mode lifecycle.
