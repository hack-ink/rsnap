...
description: "Normative requirements and invariants for Rsnap Capture Session Contract."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
macOS shell design. Use [`openwiki/spec/platform-host-boundary.md`](./platform-host-boundary.md) for the host/core boundary,
[`openwiki/reference/host-core-reset.md`](../reference/host-core-reset.md) for active migration context, and `openwiki/reference/` for
...
- Platform-native ownership of windows, focus, activation, cursor, IME, permissions, clipboard,
  ...
  [`openwiki/spec/platform-host-boundary.md`](./platform-host-boundary.md).
...
- Frozen toolbar placement and expansion invariants are governed by
  [`openwiki/spec/frozen-toolbar-layout.md`](./frozen-toolbar-layout.md).
- Pen behavior is governed by [`openwiki/spec/annotation-pen.md`](./annotation-pen.md).
...
[`openwiki/runbook/scroll-capture-recovery-plan.md`](../runbook/scroll-capture-recovery-plan.md) before claiming that the implementation satisfies
this contract.
...
- Render cadence, performance scenarios, and tracking requirements are governed by
  [`openwiki/spec/performance.md`](./performance.md).
