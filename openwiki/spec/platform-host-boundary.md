...
description: "Normative requirements and invariants for Platform Host Boundary."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
implementation notes. Use [`openwiki/spec/capture-session.md`](./capture-session.md) for product behavior,
[`openwiki/reference/workspace-layout.md`](../reference/workspace-layout.md) for the checked-in tree, and the accepted reset decision for
...
- the product-level contract in [`openwiki/spec/capture-session.md`](./capture-session.md)
- the ownership rules in this document

## Documentation rule

- Product behavior belongs in [`openwiki/spec/capture-session.md`](./capture-session.md).
- Active migration and architecture posture belong in [`openwiki/reference/host-core-reset.md`](../reference/host-core-reset.md).
- Accepted rationale for this split belongs in [`openwiki/decisions/native-host-rust-core-reset.md`](../decisions/native-host-rust-core-reset.md).
