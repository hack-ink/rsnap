...
description: "Normative requirements and invariants for Rsnap Performance Contract."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
implementation notes. Use `openwiki/runbook/` for procedures and `openwiki/reference/` for current
implementation context.

Primary procedures:
- [`openwiki/runbook/performance-validation.md`](../runbook/performance-validation.md) for repo-native performance command entrypoints
- [`openwiki/runbook/scroll-capture-benchmarks.md`](../runbook/scroll-capture-benchmarks.md) for scroll-capture benchmark fixtures and baseline
  use
