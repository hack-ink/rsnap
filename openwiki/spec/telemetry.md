...
description: "Normative requirements and invariants for Telemetry Schema."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
Not this document: Use [`openwiki/runbook/telemetry-debugging.md`](../runbook/telemetry-debugging.md) for the collection sequence.
...
The [Telemetry Debugging runbook](../runbook/telemetry-debugging.md) operationalizes this schema during live diagnosis. Performance telemetry is interpreted against the budgets in the [Performance Contract](./performance.md).
