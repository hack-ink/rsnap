...
description: "Normative requirements and invariants for Settings and App Shell Contract."
type: "Spec"
status: active
authority: normative
owner: acg-box/rsnap
...
capture-session behavior once capture has started. Use [`openwiki/spec/capture-session.md`](./capture-session.md) for
capture-flow behavior and [`openwiki/spec/platform-host-boundary.md`](./platform-host-boundary.md) for host/core ownership.
