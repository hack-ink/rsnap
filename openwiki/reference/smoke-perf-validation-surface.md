...
description: "Current-state implementation and ownership reference for Smoke/Perf Validation Surface Reference."
type: "Reference"
status: active
authority: normative
owner: acg-box/rsnap
...
Depends on: [`openwiki/runbook/performance-validation.md`](../runbook/performance-validation.md); [`openwiki/spec/performance.md`](../spec/performance.md)
...
and recovery surfaces; follow [`openwiki/runbook/scroll-capture-recovery-plan.md`](../runbook/scroll-capture-recovery-plan.md) before making a
