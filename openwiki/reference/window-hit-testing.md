...
description: "Current-state implementation and ownership reference for Window Hit-Testing Reference."
type: "Reference"
status: active
authority: normative
owner: acg-box/rsnap
...
Inputs: [`openwiki/spec/capture-session.md`](../spec/capture-session.md); current focus is the macOS live path and its current
default strategy.
...
[`openwiki/reference/host-core-reset.md`](./host-core-reset.md) and [`openwiki/spec/platform-host-boundary.md`](../spec/platform-host-boundary.md).
