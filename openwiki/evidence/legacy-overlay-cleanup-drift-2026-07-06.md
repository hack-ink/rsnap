...
- [`openwiki/reference/workspace-layout.md`](../reference/workspace-layout.md),
  [`openwiki/reference/smoke-perf-validation-surface.md`](../reference/smoke-perf-validation-surface.md), and
  [`openwiki/runbook/performance-validation.md`](../runbook/performance-validation.md) describe the current retained validation surface.
...
- [`openwiki/runbook/performance-validation.md`](../runbook/performance-validation.md)
