...
description: "Executable procedure and verification guidance for Performance Validation Runbook."
type: "Runbook"
status: active
authority: normative
owner: acg-box/rsnap
...
Inputs: `scripts/smoke/`; `scripts/perf/`; [`openwiki/spec/performance.md`](../spec/performance.md);
[`openwiki/runbook/scroll-capture-benchmarks.md`](./scroll-capture-benchmarks.md);
[`openwiki/reference/smoke-perf-validation-surface.md`](../reference/smoke-perf-validation-surface.md)

Depends on: [`openwiki/spec/performance.md`](../spec/performance.md)
...
session tests, read [`openwiki/reference/smoke-perf-validation-surface.md`](../reference/smoke-perf-validation-surface.md).
...
- [`openwiki/reference/smoke-perf-validation-surface.md`](../reference/smoke-perf-validation-surface.md) for the smoke/perf ownership map and cleanup
  boundaries.
- [`openwiki/runbook/scroll-capture-benchmarks.md`](./scroll-capture-benchmarks.md) for the scroll-capture fixture contract and
  per-target baseline commands.
- [`openwiki/reference/live-sampling.md`](../reference/live-sampling.md) for the stream-first live cursor and loupe path that
