...
Commit message
- proposed: `{"schema":"cmsg/1","type":"docs","scope":"plans","summary":"add rsnap design and implementation plan","intent":"document v1 design and execution plan","impact":"adds initial rsnap design and implementation plan docs","breaking":false,"risk":"low","refs":[]}`
