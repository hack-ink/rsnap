...
Commit message
- proposed: `{"schema":"cmsg/1","type":"fix","scope":"editor","summary":"satisfy vstyle in editor backend","intent":"make cargo make checks pass","impact":"reorders functions and adjusts spacing in tauri command/export helpers","breaking":false,"risk":"low","refs":[]}`
