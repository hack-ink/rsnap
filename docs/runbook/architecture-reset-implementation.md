...
Inputs: The chosen reset slice; `docs/spec/platform-host-boundary.md`;
`docs/spec/capture-session.md`; `docs/reference/host-core-reset.md`; `Makefile.toml`

Depends on: `docs/spec/platform-host-boundary.md`; `docs/spec/capture-session.md`;
`docs/reference/host-core-reset.md`; `docs/runbook/architecture-reset-validation.md`
...
- update `docs/spec/platform-host-boundary.md` if ownership rules changed
- update `docs/spec/capture-session.md` if product behavior changed
- update `docs/reference/host-core-reset.md` if the active migration posture changed
- update this runbook or `docs/runbook/architecture-reset-validation.md` if the execution or
