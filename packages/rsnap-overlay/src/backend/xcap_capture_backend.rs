...
#[cfg(target_os = "macos")]
use crate::backend::macos_region_capture;
use crate::backend::{CaptureBackend, CaptureBackendError, image_capture, window_list};
#[cfg(target_os = "macos")]
...
pub(super) struct XcapCaptureBackend {
...
impl XcapCaptureBackend {
	...
	pub(super) fn with_self_capture_exception_window_ids(
		self_capture_exception_window_ids: Vec<u32>,
	) -> Self {
		#[cfg(not(target_os = "macos"))]
