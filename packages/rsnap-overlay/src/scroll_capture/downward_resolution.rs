...
use crate::scroll_capture::{
	...
	DOWNWARD_VIEWPORT_AUTHORITY_GAP_ROWS, DownwardRegistration, DownwardSampleMatch,
	DownwardSampleMatchSource, DownwardViewportCandidate, DownwardViewportCandidateSource,
	DownwardViewportResolution, FALLBACK_DOWNWARD_GROWTH_MAX_ROWS,
	FALLBACK_DOWNWARD_GROWTH_MIN_ROWS, GrowthCommit, MotionObservation, OverlapSearchConfig,
	PREVIEW_ONLY_LOCAL_NEAR_CONTINUITY_ROWS, PREVIEW_ONLY_LOCAL_RECOVERY_MAX_MOTION_ROWS,
	PREVIEW_ONLY_LOCAL_RECOVERY_MAX_TOLERANCE_ROWS, RgbaImage, ScrollDirection,
	ScrollObserveOutcome, ScrollSession, TRANSIENT_BURST_UNDERCONSUMED_HINT_MIN_ROWS,
